...
class ProblemRunner {
  ...
  private showHelp() {
    ...
    console.log(
      "  npm run dev:6    # Run problem #6 main() function with hot reload"
    );
    console.log(
      "  npm run dev:7    # Run problem #7 main() function with hot reload"
    );
    console.log(
      "  npm run dev:8    # Run problem #8 main() function with hot reload"
    );
    console.log(
      "  npm run dev:9    # Run problem #9 main() function with hot reload"
    );
    console.log(
      "  npm run dev:10   # Run problem #10 main() function with hot reload"
    );
    console.log(
      "  npm run dev:11   # Run problem #11 main() function with hot reload"
    );
    console.log(
    ...
    console.log("  npm run test:6   # Run Jest tests for problem #6");
    console.log("  npm run test:7   # Run Jest tests for problem #7");
    console.log("  npm run test:8   # Run Jest tests for problem #8");
    console.log("  npm run test:9   # Run Jest tests for problem #9");
